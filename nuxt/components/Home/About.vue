            ...
            <div class="mt-8 lg:mt-0">
                ...
                >
                    ...
                    <p class="fade-in">
                        ...
                        full-time (with a 3.96 GPA, whoop!). I also project manage and work
                    ...
                    <p class="fade-in">
                        ...
                        <NuxtLink
                            class="text-secondary underline underline-offset-2"
                            to="/publications"
                        >three distinct 300-level guest lectures
                        </NuxtLink
                        >
