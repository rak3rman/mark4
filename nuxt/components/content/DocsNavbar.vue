<template>
  <div
    class="fixed left-0 right-0 top-0 z-50 border-b-[1px] border-accent/[0.15] bg-base-200/[0.8] backdrop-blur-xl backdrop-saturate-150 transition delay-100 duration-300 ease-in"
  >
