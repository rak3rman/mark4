<template>
  <footer class="">
    <div class="pt-16 md:flex md:items-center md:justify-between">
      ...
      <div class="mt-8 md:mt-0 md:order-1">
        ...
        <div>
          <h6 class="text-center text-sm text-neutral opacity-70 md:float-left md:mr-1 pb-1">Privacy Policy. Legal Notice.</h6>
          <h6 class="text-center text-sm text-neutral opacity-70 md:float-left md:mr-1 pb-1"><a href="https://github.com/rak3rman/mark4">Mark 4. Release {{ config.public.gitMasterTag }}.</a></h6>
        </div>
      </div>
    </div>
  </footer>
