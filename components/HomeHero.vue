      ...
      <div class="lg:col-span-3 flex items-center">
        <div class="flex flex-col w-full justify-center overflow-y-hidden">
          ...
          <p class="py-2 leading-normal text-accent text-lg md:text-lg max-w-2xl text-left">
            ...
            Currently, I'm co-building <a class="text-secondary underline underline-offset-2" href="https://pulqra.com">Pulqra</a>, a creative marketing collective where we've completely reimagined over 200 artists and businesses.
          </p>
          <span class="py-3 inline-flex rounded-md shadow">
            <a href="#projects" class="inline-flex items-center px-4 py-2 border border-secondary text-base leading-normal font-mono rounded-md text-secondary hover:bg-primary-focus"> Check out my lecture at UIC! </a>
          </span>
        </div>
      </div>
    </div>
