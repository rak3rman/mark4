    ...
    <div>
      ...
      <div class="mt-8 lg:grid lg:grid-cols-5 lg:gap-8 w-full">
        <div class="flex justify-center lg:row-start-1 lg:col-start-1 lg:col-span-2">
          <div class="text-[0.9rem] text-accent font-mono text-left mb-10 mt-0 lg:mt-4 fade-in">
            <h6 class="pb-4">
              <strong>What's next? Well, that is up to you.</strong> Here's a few options based on what
              your looking for:
            </h6>
            <h6 class="pb-4">
              >> <strong>A. "HELP! I'm searching far and wide for a computer wizard"</strong>
            ...
            <h6 class="pb-4">
              >> <strong>B. "I need a group of highly-driven creatives that can do anything"</strong> <br>
              <i>Check out
            ...
            <h6 class="pb-4">
              ...
              inbox is always open. I'm constantly <s>running</s> cycling around, so when I come to a stop
              I'll give you a shout.</i>
            </h6>
            <h6 class="">
        ...
        <div class="lg:col-span-3 flex items-center">
          <form action="https://informr.rakerman.com/in/q5y6j3N2" method="POST"
            ...
            <div class="sm:col-span-2">
              ...
              <NuxtLink to="https://informr.rakerman.com"
