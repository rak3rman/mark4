<template>
  <Popover class="fixed top-0 left-0 right-0 backdrop-blur-xl z-10">
      ...
      >
        ...
        >
          <div class="flex items-center justify-between w-full md:w-auto">
            ...
            <div
              class="-mr-2 flex items-center md:hidden fade-in-nav"
        ...
        >
          ...
          <span
            class="inline-flex rounded-md shadow fade-in-nav"
            :style="{
    ...
    >
      ...
      >
        <div
          class="rounded-lg shadow-md bg-primary-focus ring-1 ring-black ring-opacity-5 overflow-hidden"
        >
