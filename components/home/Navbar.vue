        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4">
            <nav class="relative flex items-center justify-between sm:h-10 md:justify-center" aria-label="Global">
                <div class="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
                    <div class="flex items-center justify-between w-full md:w-auto">
                        <NuxtLink to="/" class="fade-in-nav">
                            ...
                            <img class="h-5 w-auto sm:h-6"
                                 src="https://imagedelivery.net/5zM6Rdl2uV8Hmr9WxRh20g/7ed7598b-5520-4e18-5159-daa458739b00/sm"
                                 alt="RAkerman Logo"/>
                        </NuxtLink>
                        <div class="-mr-2 flex items-center md:hidden fade-in-nav"
                             :style="{ 'transition-delay': 100 + 'ms' }">
                            <PopoverButton
                                    class="bg-primary-focus rounded-md p-2 inline-flex items-center justify-center text-accent focus:outline-none focus:ring-2 focus:ring-inset focus:ring-secondary">
                ...
                <div class="hidden md:absolute md:flex md:items-center md:justify-end md:inset-y-0 md:right-0">
                    ...
                    <span class="inline-flex rounded-md shadow fade-in-nav"
                          :style="{ 'transition-delay': navigation.length*100+300 + 'ms' }">
            <NuxtLink to="/resume.pdf" target="_blank"
                      class="inline-flex items-center px-4 py-2 border border-secondary text-sm font-mono rounded-md text-secondary hover:bg-primary-focus"> Resume </NuxtLink>
          </span>
                </div>
            </nav>
        </div>
