    ...
    <div class="mx-auto py-3 px-3 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between flex-wrap">
        <div class="w-0 flex-1 flex items-center" onclick="window.open('https://status.rakerman.com', '_blank');">
          ...
          <h6 class="ml-3 text-sm sm:text-md leading-4 text-white truncate">
            <strong>
              <span id="raf_alert_title">Site Maintenance</span>:
            </strong>
            <span id="raf_alert_time">Through Next Hour</span>
            <br>
