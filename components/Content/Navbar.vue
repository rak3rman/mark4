    ...
    <div class="fixed top-0 left-0 right-0 backdrop-blur-xl z-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4">
            <nav class="relative flex items-center h-10 justify-center" aria-label="Global">
                ...
                <div class="absolute flex items-center justify-end inset-y-0 right-0 fade-in-nav"
                     :style="{ 'transition-delay': 100 + 'ms' }">
			          <span class="inline-flex rounded-md shadow">
			            <NuxtLink to="/"
                           class="inline-flex items-center px-4 py-2 border border-secondary text-sm font-mono rounded-md text-secondary hover:bg-primary-focus"> Back Home </NuxtLink>
			          </span>
                </div>
            </nav>
        </div>
